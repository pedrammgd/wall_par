                ...
                if (state is WallpaperCategoryInitial ||
                  ...
                  return Column(
                    ...
                    children: [
                      IconButton(
                        onPressed: () {
                          context.bloc<CategoryWallpaperBloc>()
                            ..isFetching = true
                            ..add(CategoryWallpaper(category: widget.category));
                        },
                ...
                return SingleChildScrollView(
                  controller: _scrollController
                    ..addListener(() {
                      if (_scrollController.offset ==
                          ...
                          !context.read<CategoryWallpaperBloc>().isFetching) {
                        context.read<CategoryWallpaperBloc>()
                          ..isFetching = true
                          ..add(CategoryWallpaper(category: widget.category));
                      }
                  ...
                  child: Column(
                    children: [
                      ...
                      if (context.read<CategoryWallpaperBloc>().isFetching)
                        Center(
                            child: LoadingAnimationWidget.threeRotatingDots(
                                color: Colors.black, size: 20)),
                      SizedBox(
